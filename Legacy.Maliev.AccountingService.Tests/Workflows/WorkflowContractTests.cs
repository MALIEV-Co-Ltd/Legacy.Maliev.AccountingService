...
namespace Legacy.Maliev.AccountingService.Tests.Workflows;
...
public sealed class WorkflowContractTests
{
    ...
    [Fact]
    public void DependabotConfiguration_AllowsCoordinatedEfUpdates()
    {
        var source = File.ReadAllText(FindRepositoryFile(".github", "dependabot.yml"));
    ...
    {
        AssertMutationRejected(
            "          solution: Legacy.Maliev.AccountingService.slnx",
            "          solution: Legacy.Maliev.AccountingService.slnx\n      - run: dotnet  restore Legacy.Maliev.AccountingService.slnx");
    }
