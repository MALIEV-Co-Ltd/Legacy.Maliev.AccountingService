...
public interface IAccountingService
{
    ...
    Task<PaginatedResponse<Invoice>?> GetInvoicesAsync(int? customerId, string? search, int page, int size, CancellationToken c); Task<IReadOnlyList<InvoiceOrderItem>> GetInvoiceItemsAsync(int invoiceId, CancellationToken c); Task<IReadOnlyList<InvoiceFile>> GetInvoiceFilesAsync(int invoiceId, CancellationToken c);
